...
include 'header.php'; ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Suplier Matahari Motor</h1>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin?')" href="hapusuplier.php?id_sup=<?= $res['id_sup'] ?>">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                   </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Data Suplier</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">x</button>
      </div>
      <div class="modal-body">
        <form action="datasuplier.php" method="POST">
        	<input class="form-control mb-2" type="text" name="nama" placeholder="Nama Suplier">
        	<input class="form-control mb-2" type="text" name="telp" placeholder="Telp Suplier">
        	<input class="form-control mb-2" type="text" name="jenis" placeholder="Jenis Suplier">
        	<textarea placeholder="Alamat Suplier" class="form-control" name="alamat"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="Submit" name="suplier" class="btn btn-primary">Simpan</button>
        </form>
      </div>
    </div>
  </div>
