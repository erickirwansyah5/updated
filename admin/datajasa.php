...
include 'function/format_rupiah.php'; ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Jasa Matahari Motor</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	<?php $query = "SELECT * FROM barangjasa WHERE jenis = 'jasa' ORDER BY id_brg ASC";
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin?')" href="hapusuplier.php?id_jasa=<?= $res['id_brg'] ?>">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                   </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="datajasa.php" method="POST">
        	<input class="form-control mb-2" type="text" name="nama" placeholder="Nama Jasa">
          <input class="form-control mb-2" type="hidden" name="jenis" value="jasa">
          <input class="form-control mb-2" type="text" name="harga_jual" placeholder="Harga">
        	<textarea placeholder="Keterangan Jasa" class="form-control" name="ket"></textarea>
      </div>
...
if(isset($_POST['barang'])) {
 ...
 $query = "INSERT INTO barangjasa(nama,jenis,harga_jual,ket) VALUES ('$nama','$jenis','$harga_jual','$ket')";
 $exec = mysqli_query($conn,$query);
 if($exec) {
 	echo "<script> alert('Data Berhasil disimpan')</script>";
 	echo "<script type='text/javascript'> document.location = 'datajasa.php'; </script>";
 }
