...
$kode = $res['id_trx'];
$sql = "SELECT trx.*,montir.*, tmp_trx.*, barangjasa.*, konsumen.* FROM montir, trx, tmp_trx, barangjasa, konsumen WHERE trx.id_trx=tmp_trx.id_trx AND trx.id_kon=konsumen.id_kon AND tmp_trx.id_brg=barangjasa.id_brg AND trx.id_montir = montir.id_montir AND trx.id_trx='". $res['id_trx'] ."'";
...
<b>Montir : <?= $result['nama_montir'] ?></b></br>
</td>
</table>
<table style='width:550px; font-size:8pt; font-family:calibri; border-collapse: collapse;' border = '0'>
<td width='70%' align='left' style='padding-right:80px; vertical-align:top'>
